        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-6 md:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-2 md:mb-3 leading-tight">
              Apenas 36 vagas disponíveis • Expira em 09:25
            </h2>
          </div>
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl border-4 border-red-500 overflow-hidden">
              ...
              <div className="p-6 md:p-8 lg:p-10">
                ...
                <button
                  ...
                  className="w-full text-center text-white font-black text-xl md:text-2xl px-8 py-6 md:py-7 rounded-full shadow-2xl transition-all duration-300 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 transform hover:scale-105 animate-pulse mb-4"
                >
